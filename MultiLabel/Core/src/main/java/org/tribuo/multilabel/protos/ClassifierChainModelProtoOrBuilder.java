...
public interface ClassifierChainModelProtoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:tribuo.multilabel.ClassifierChainModelProto)
   ...
   * <code>repeated .tribuo.core.OutputProto label_order = 3;</code>
   */
  org.tribuo.protos.core.OutputProto getLabelOrder(int index);
  /**
   * <code>repeated .tribuo.core.OutputProto label_order = 3;</code>
   */
  int getLabelOrderCount();
  /**
   * <code>repeated .tribuo.core.OutputProto label_order = 3;</code>
   */
   ...
   * <code>repeated .tribuo.core.OutputProto label_order = 3;</code>
   */
  org.tribuo.protos.core.OutputProtoOrBuilder getLabelOrderOrBuilder(
      int index);
}
