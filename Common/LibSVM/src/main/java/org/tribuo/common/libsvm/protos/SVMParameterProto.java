...
private static final long serialVersionUID = 0L;
  ...
  private SVMParameterProto(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(org.tribuo.common.libsvm.protos.SVMParameterProto result) {
    ...
    public Builder mergeFrom(org.tribuo.common.libsvm.protos.SVMParameterProto other) {
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getCoef0()) != 0) {
        setCoef0(other.getCoef0());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getCacheSize()) != 0) {
        setCacheSize(other.getCacheSize());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getEps()) != 0) {
        setEps(other.getEps());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getC()) != 0) {
        setC(other.getC());
      }
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getNu()) != 0) {
        setNu(other.getNu());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getP()) != 0) {
        setP(other.getP());
      }
    ...
    private void ensureWeightLabelIsMutable() {
      if (!weightLabel_.isModifiable()) {
        weightLabel_ = makeMutableCopy(weightLabel_);
      }
      bitField0_ |= 0x00000200;
    }
    /**
