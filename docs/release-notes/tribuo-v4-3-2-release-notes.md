...
* Moving to TF-Java 1.0.0 by @craigacp in https://github.com/oracle/tribuo/pull/367. Note the TensorFlow interface now requires Java 11, as TF-Java v1.0 requires Java 11.
