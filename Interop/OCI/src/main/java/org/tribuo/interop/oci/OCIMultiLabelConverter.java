...
public final class OCIMultiLabelConverter implements OCIOutputConverter<MultiLabel> {
     ...
     */
    public static OCIMultiLabelConverter deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
