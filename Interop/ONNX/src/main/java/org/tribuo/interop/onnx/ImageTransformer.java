...
public class ImageTransformer implements ExampleTransformer {
     ...
     */
    public static ImageTransformer deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
