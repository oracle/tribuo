...
public class ImageConverter implements FeatureConverter {
     ...
     */
    public static ImageConverter deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
