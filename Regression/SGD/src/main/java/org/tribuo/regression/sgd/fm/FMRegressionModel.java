...
public class FMRegressionModel extends AbstractFMModel<Regressor> implements ONNXExportable {
     ...
     */
    public static FMRegressionModel deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
