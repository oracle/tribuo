...
private static final long serialVersionUID = 0L;
  ...
  private RegressorProto(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(org.tribuo.regression.protos.RegressorProto result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              ...
              int limit = input.pushLimit(length);
              int alloc = length > 4096 ? 4096 : length;
              ensureVarianceIsMutable(alloc / 8);
              while (input.getBytesUntilLimit() > 0) {
    ...
    private void ensureVarianceIsMutable() {
      if (!variance_.isModifiable()) {
        variance_ = makeMutableCopy(variance_);
      }
      bitField0_ |= 0x00000004;
    }
    private void ensureVarianceIsMutable(int capacity) {
      if (!variance_.isModifiable()) {
        variance_ = makeMutableCopy(variance_, capacity);
      }
      bitField0_ |= 0x00000004;
    }
    /**
