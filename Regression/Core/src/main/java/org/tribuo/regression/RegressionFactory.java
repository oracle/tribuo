...
public final class RegressionFactory implements OutputFactory<Regressor> {
     ...
     */
    public static RegressionFactory deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
