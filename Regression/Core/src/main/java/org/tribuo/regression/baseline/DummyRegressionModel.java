...
public class DummyRegressionModel extends Model<Regressor> {
     ...
     */
    public static DummyRegressionModel deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
