...
public final class Event implements Output<Event> {
     ...
     */
    public static Event deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
