...
public final class MutableAnomalyInfo extends AnomalyInfo implements MutableOutputInfo<Event> {
     ...
     */
    public static MutableAnomalyInfo deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
