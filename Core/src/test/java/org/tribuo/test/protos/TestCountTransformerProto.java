...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 4,
      /* suffix= */ "",
      "TestCountTransformerProto");
  }
  // Use TestCountTransformerProto.newBuilder() to construct.
  private TestCountTransformerProto(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(org.tribuo.test.protos.TestCountTransformerProto result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              ...
              ensureCountMapKeysIsMutable(alloc / 8);
    ...
    private void ensureCountMapKeysIsMutable() {
      if (!countMapKeys_.isModifiable()) {
        countMapKeys_ = makeMutableCopy(countMapKeys_);
      }
      bitField0_ |= 0x00000004;
    }
    private void ensureCountMapKeysIsMutable(int capacity) {
      if (!countMapKeys_.isModifiable()) {
        countMapKeys_ = makeMutableCopy(countMapKeys_, capacity);
      }
      bitField0_ |= 0x00000004;
    }
    /**
    ...
    private void ensureCountMapValuesIsMutable() {
      if (!countMapValues_.isModifiable()) {
        countMapValues_ = makeMutableCopy(countMapValues_);
      }
      bitField0_ |= 0x00000008;
    }
    /**
