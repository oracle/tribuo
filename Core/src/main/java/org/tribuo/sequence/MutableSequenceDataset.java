...
public class MutableSequenceDataset<T extends Output<T>> extends SequenceDataset<T> {
    ...
    public static MutableSequenceDataset<?> deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
