...
public class RealInfo extends SkeletalVariableInfo {
     ...
     */
    public static RealInfo deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
