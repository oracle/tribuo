...
public class RealIDInfo extends RealInfo implements VariableIDInfo {
     ...
     */
    public static RealIDInfo deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
