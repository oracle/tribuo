...
private static final long serialVersionUID = 0L;
  ...
  private IDFTransformerProto(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(org.tribuo.protos.core.IDFTransformerProto other) {
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getDf()) != 0) {
        setDf(other.getDf());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getN()) != 0) {
        setN(other.getN());
      }
