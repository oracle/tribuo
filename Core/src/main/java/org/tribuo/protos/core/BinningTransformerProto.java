...
private static final long serialVersionUID = 0L;
  ...
  private BinningTransformerProto(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    getSerializedSize();
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(binningType_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, binningType_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(binningType_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, binningType_);
    }
    {
      int dataSize = 0;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(org.tribuo.protos.core.BinningTransformerProto result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              binningType_ = input.readStringRequireUtf8();
              bitField0_ |= 0x00000001;
              break;
            } // case 10
            case 17: {
    ...
    private void ensureBinsIsMutable() {
      if (!bins_.isModifiable()) {
        bins_ = makeMutableCopy(bins_);
      }
      bitField0_ |= 0x00000002;
    }
    private void ensureBinsIsMutable(int capacity) {
      if (!bins_.isModifiable()) {
        bins_ = makeMutableCopy(bins_, capacity);
      }
      bitField0_ |= 0x00000002;
    }
    /**
