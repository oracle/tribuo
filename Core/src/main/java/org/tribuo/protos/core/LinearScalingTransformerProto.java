...
private static final long serialVersionUID = 0L;
  ...
  private LinearScalingTransformerProto(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  private double observedMin_ = 0D;
  /**
  ...
  private double observedMax_ = 0D;
  /**
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(org.tribuo.protos.core.LinearScalingTransformerProto result) {
    ...
    public Builder mergeFrom(org.tribuo.protos.core.LinearScalingTransformerProto other) {
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getObservedMin()) != 0) {
        setObservedMin(other.getObservedMin());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getObservedMax()) != 0) {
        setObservedMax(other.getObservedMax());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getTargetMin()) != 0) {
        setTargetMin(other.getTargetMin());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getTargetMax()) != 0) {
