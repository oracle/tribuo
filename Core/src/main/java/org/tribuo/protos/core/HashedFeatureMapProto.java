...
private static final long serialVersionUID = 0L;
  ...
  private HashedFeatureMapProto(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(org.tribuo.protos.core.HashedFeatureMapProto result) {
      if (infoBuilder_ == null) {
    ...
    private void buildPartial0(org.tribuo.protos.core.HashedFeatureMapProto result) {
      int from_bitField0_ = bitField0_;
      int to_bitField0_ = 0;
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.hasher_ = hasherBuilder_ == null
            ? hasher_
            : hasherBuilder_.build();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  internalGetHasherFieldBuilder().getBuilder(),
                  extensionRegistry);
              bitField0_ |= 0x00000001;
              break;
            } // case 10
            case 18: {
              org.tribuo.protos.core.VariableInfoProto m =
                  input.readMessage(
                      org.tribuo.protos.core.VariableInfoProto.parser(),
                      extensionRegistry);
              if (infoBuilder_ == null) {
                ensureInfoIsMutable();
                info_.add(m);
    ...
    public Builder mergeHasher(org.tribuo.protos.core.HasherProto value) {
      if (hasherBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          hasher_ != null &&
          hasher_ != org.tribuo.protos.core.HasherProto.getDefaultInstance()) {
          getHasherBuilder().mergeFrom(value);
        } else {
          hasher_ = value;
        }
      } else {
    ...
    public org.tribuo.protos.core.HasherProto.Builder getHasherBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetHasherFieldBuilder().getBuilder();
    }
    /**
     * <code>.tribuo.core.HasherProto hasher = 1;</code>
     */
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        internalGetHasherFieldBuilder() {
      if (hasherBuilder_ == null) {
        hasherBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            org.tribuo.protos.core.HasherProto, org.tribuo.protos.core.HasherProto.Builder, org.tribuo.protos.core.HasherProtoOrBuilder>(
                getHasher(),
