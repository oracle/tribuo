...
private static final long serialVersionUID = 0L;
  ...
  private SimpleTransformProto(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(org.tribuo.protos.core.SimpleTransformProto other) {
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getFirstOperand()) != 0) {
        setFirstOperand(other.getFirstOperand());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getSecondOperand()) != 0) {
