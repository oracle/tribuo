...
private static final long serialVersionUID = 0L;
  ...
  private IndexedArrayExampleProto(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
...
java.lang.String defaultValue) {
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < featureName_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, featureName_.getRaw(i));
    }
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(org.tribuo.protos.core.IndexedArrayExampleProto result) {
    ...
    private void ensureFeatureIdxIsMutable() {
      if (!featureIdx_.isModifiable()) {
        featureIdx_ = makeMutableCopy(featureIdx_);
      }
      bitField0_ |= 0x00000008;
    }
    /**
