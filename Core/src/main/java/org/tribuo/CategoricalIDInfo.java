...
public class CategoricalIDInfo extends CategoricalInfo implements VariableIDInfo {
     ...
     */
    public static CategoricalIDInfo deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
