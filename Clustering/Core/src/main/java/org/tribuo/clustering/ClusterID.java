...
public class ClusterID implements Output<ClusterID> {
     ...
     */
    public static ClusterID deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
