...
public class MutableClusteringInfo extends ClusteringInfo implements MutableOutputInfo<ClusterID> {
     ...
     */
    public static MutableClusteringInfo deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
