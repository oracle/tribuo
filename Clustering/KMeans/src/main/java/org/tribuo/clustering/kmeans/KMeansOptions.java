...
public class KMeansOptions implements Options {
    ...
    @Option(longName="kmeans-initialisation",usage="Initialisation function " +
            "in K-Means. Defaults to UNIFORM.")
    ...
    public KMeansTrainer getTrainer() {
        ...
        return new KMeansTrainer(centroids,iterations,distance,initialisation
                ,numThreads,seed);
    }
}
