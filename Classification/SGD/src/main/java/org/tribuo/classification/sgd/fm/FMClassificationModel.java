...
public class FMClassificationModel extends AbstractFMModel<Label> implements ONNXExportable {
     ...
     */
    public static FMClassificationModel deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
