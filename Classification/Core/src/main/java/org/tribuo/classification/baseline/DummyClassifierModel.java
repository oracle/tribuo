...
public class DummyClassifierModel extends Model<Label> {
     ...
     */
    public static DummyClassifierModel deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
