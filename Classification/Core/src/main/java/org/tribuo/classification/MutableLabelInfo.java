...
public class MutableLabelInfo extends LabelInfo implements MutableOutputInfo<Label> {
     ...
     */
    public static MutableLabelInfo deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
