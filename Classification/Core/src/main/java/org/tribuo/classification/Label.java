...
public final class Label implements Classifiable<Label> {
     ...
     */
    public static Label deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
