...
public class DefaultFeatureExtractor implements LabelFeatureExtractor {
     ...
     */
    public static DefaultFeatureExtractor deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
