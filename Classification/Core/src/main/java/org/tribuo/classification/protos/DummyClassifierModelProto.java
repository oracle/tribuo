...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 4,
      /* suffix= */ "",
      "DummyClassifierModelProto");
  }
  // Use DummyClassifierModelProto.newBuilder() to construct.
  private DummyClassifierModelProto(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage
        ...
        internalGetConstantLabelFieldBuilder();
      }
    }
    @java.lang.Override
    ...
    private void buildPartial0(org.tribuo.classification.protos.DummyClassifierModelProto result) {
      ...
      if (((from_bitField0_ & 0x00000004) != 0)) {
        result.constantLabel_ = constantLabelBuilder_ == null
            ? constantLabel_
            : constantLabelBuilder_.build();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              input.readMessage(
                  internalGetConstantLabelFieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    public Builder mergeConstantLabel(org.tribuo.protos.core.OutputProto value) {
      if (constantLabelBuilder_ == null) {
        if (((bitField0_ & 0x00000004) != 0) &&
          constantLabel_ != null &&
          constantLabel_ != org.tribuo.protos.core.OutputProto.getDefaultInstance()) {
          getConstantLabelBuilder().mergeFrom(value);
        } else {
          constantLabel_ = value;
        }
      } else {
    ...
    public org.tribuo.protos.core.OutputProto.Builder getConstantLabelBuilder() {
      bitField0_ |= 0x00000004;
      onChanged();
      return internalGetConstantLabelFieldBuilder().getBuilder();
    }
    /**
     * <code>.tribuo.core.OutputProto constant_label = 3;</code>
     */
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        internalGetConstantLabelFieldBuilder() {
      if (constantLabelBuilder_ == null) {
        constantLabelBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            org.tribuo.protos.core.OutputProto, org.tribuo.protos.core.OutputProto.Builder, org.tribuo.protos.core.OutputProtoOrBuilder>(
                getConstantLabel(),
                getParentForChildren(),
                isClean());
    ...
    private void ensureCdfIsMutable() {
      if (!cdf_.isModifiable()) {
        cdf_ = makeMutableCopy(cdf_);
      }
      bitField0_ |= 0x00000008;
    }
    private void ensureCdfIsMutable(int capacity) {
      if (!cdf_.isModifiable()) {
        cdf_ = makeMutableCopy(cdf_, capacity);
      }
      bitField0_ |= 0x00000008;
    }
    /**
