...
public final class VotingCombiner implements EnsembleCombiner<Label> {
     ...
     */
    public static VotingCombiner deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) {
    ...
    public boolean equals(Object o) {
        return o instanceof VotingCombiner;
    }
