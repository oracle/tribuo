...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 4,
      /* suffix= */ "",
      "AdaGradRDADenseTensorProto");
  }
  // Use AdaGradRDADenseTensorProto.newBuilder() to construct.
  private AdaGradRDADenseTensorProto(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(org.tribuo.math.protos.AdaGradRDADenseTensorProto result) {
    ...
    public Builder mergeFrom(org.tribuo.math.protos.AdaGradRDADenseTensorProto other) {
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getEpsilon()) != 0) {
        setEpsilon(other.getEpsilon());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getL1()) != 0) {
        setL1(other.getL1());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getL2()) != 0) {
        setL2(other.getL2());
      }
      if (!other.getGradNorms().isEmpty()) {
