...
public class SparseVector implements SGDVector {
     ...
     */
    public static SparseVector deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
