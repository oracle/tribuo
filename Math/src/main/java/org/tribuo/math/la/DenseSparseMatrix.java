...
public class DenseSparseMatrix implements Matrix {
     ...
     */
    public static DenseSparseMatrix deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
