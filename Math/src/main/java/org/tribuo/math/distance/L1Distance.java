...
public final class L1Distance implements Distance {
     ...
     */
    public static L1Distance deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) {
    ...
    public double computeDistance(SGDVector first, SGDVector second) {
        return first.l1Distance(second);
    }
    ...
    public boolean equals(Object o) {
        return o instanceof L1Distance;
    }
