...
public class ShrinkingVector extends DenseVector implements ShrinkingTensor {
     ...
     */
    public static ShrinkingVector deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
