...
public class ShrinkingMatrix extends DenseMatrix implements ShrinkingTensor {
     ...
     */
    public static ShrinkingMatrix deserializeFromProto(int version, String className, Any message, ProtoDeserializationCache deserCache) throws InvalidProtocolBufferException {
