...
public class WordpieceTokenizer implements Tokenizer {
    ...
    @Config
    private WordpieceBuilder wordpieceBuilder;
    private Wordpiece wordpiece; //created by wordpieceBuilder in postConfig()
    @Config
    ...
    /**
     * @param wordpieceBuilder builds an instance of {@link Wordpiece}
     ...
     */
    public WordpieceTokenizer(WordpieceBuilder wordpieceBuilder, Tokenizer tokenizer, boolean toLowerCase, boolean stripAccents, Set<String> neverSplitTokens) {
    	this.wordpieceBuilder = wordpieceBuilder;
    	this.tokenizer = tokenizer;
    	this.toLowerCase = toLowerCase;
    	this.stripAccents = stripAccents;
    	this.neverSplitTokens = neverSplitTokens;
    	try {
    		postConfig();
    	} catch(IOException e) {
	...
	public void postConfig() throws IOException {
		this.wordpiece = this.wordpieceBuilder.build();
	}
