...
public class WordpiecePreprocessTokenizer extends SplitFunctionTokenizer {
	...
	public static SplitFunction whitespaceSplitCharacterFunction = (codepoint, index, cs) -> {
...
//		int charType = Character.getType(codepoint);
		//		if(charType == Character.OTHER_LETTER) {  //charType == Character.COMBINING_SPACING_MARK ||
...
//		}
	...
	public static boolean isControl(int codepoint) {
		...
		//implementation.  You can experiment with adding these lines back in if you are getting
